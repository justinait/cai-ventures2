            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-12 col-md-6 col-lg-6 col-xl-6 cards">
                        ...
                        <h3 className="color-text titutos-services">Asesoría integral</h3>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-6 cards">
                        ...
                        <h3 className="color-text titutos-services">Investigadores</h3>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 col-xl-6 cards">
                        ...
                        <h3 className="color-text titutos-services">Plataforma virtual</h3>
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-12 col-lg-12">
                        ...
                        <h3 className='titutos-services'>Plan de tesis</h3>
                    ...
                    <div className="col-12 col-lg-12">
                        ...
                        <h3 className='titutos-services'>Borrador de Tesis</h3>
                    ...
                    <div className="col-12 col-lg-12">
                        ...
                        <h3 className='titutos-services'>Sustentación</h3>
