...
import bancoNacionPago from '../../../assets/bnPagos.png';

function BancoNacionScreen ({ reiniciarEstado }) { 
                        ...
                        <Col>
                            ...
                            {copiedCuenta ? (
                                ...
                                <button className='contTitular' onClick={() => handleCopyLink(textLinkRefCuenta, setCopiedCuenta)}>
                                    <p className='nameTitular' ref={textLinkRefCuenta}>04-181-774253</p>
                                    <Image src={linkCopiarBn} />
                                </button>
                            )}
                        </Col>
                        <Col>
                            ...
                            {copiedCCI ? (
                                ...
                                <button className='contTitular' onClick={() => handleCopyLink(textLinkRefCCI, setCopiedCCI)}>
                                    <p className='nameTitular' ref={textLinkRefCCI}>018-181-004181774253-83</p>
                                    <Image src={linkCopiarBn} />
                                </button>
                            )}
                        </Col>
...
export default BancoNacionScreen;
