        ...
        <>
            <footer className='footer'>
                ...
                <div className='containerHelp'>
                    <h4>Ayuda</h4>
                    <ul className='list listAnimation'>
                        <li><Link className='linkFooter' to='/'>Politicas de Privacidad</Link></li>
                        <li><Link className='linkFooter' to='/'>Términos y Condiciones</Link></li>
                    </ul>
                </div>
            </footer>
            <footer className='mobileFooterContainer'>
                ...
                <div className='mobileInfoFooter'>
                    ...
                    <div className='listConditions'>
                        <Link className='linkFooter' to='/'>Politicas de Privacidad</Link>
                        <Link className='linkFooter' to='/'>Términos y Condiciones</Link>
                    </div>
                </div>
            </footer>
        </>
